#!/usr/bin/env python3
"""VelardTools v1 - server lokal dengan COOP/COEP.

Diperlukan untuk FFmpeg WASM multi-thread (SharedArrayBuffer) di localhost.
Jalankan:  python server.py [port]   (default port 8000)
