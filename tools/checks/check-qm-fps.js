...
function mp4File(withAudio) {
  const payload = new Uint8Array(450); // 100+200+150
  const ftyp = box("ftyp", new Uint8Array(16));
  // pass 1: offset placeholder
...
// wiring: cabang fps memakai patch FPS, binary memakai patch HD
