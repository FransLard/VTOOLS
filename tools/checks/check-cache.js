...
// struktur: binding cache harus di top-level, di luar snapPicture & di luar close-handler
...
window.eval(js);
// skenario bug: klik cache SEBELUM snap apa pun — harus jalan + toast muncul
...
// klik 2x — pastikan tidak ada duplikasi listener fatal (fungsi tetap jalan)
cb.click();
console.log("DOUBLE-CLICK aman: OK");
// close-handler snap tidak lagi mendaftarkan ulang (cek: tidak ada addEventListener di dalam close handler)
